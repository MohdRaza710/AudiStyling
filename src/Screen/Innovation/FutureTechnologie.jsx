    ...
    return (
        <div>
            ...
            <div className='tech-section1'>
                <div className='tech-image-conttainer1'>
                    <img className='tech-image1' src={Image53} alt="" />
                </div>

                <div className='tech-content1'>
                    <h3 className='tech-title1'>Artificial Intelligence</h3>
                    ...
                    <a className='tech-read-btn1'>Read More</a>
                </div>

            </div>

            <div className='tech-section2'>
                <div className='tech-heading-content'>
                ...
                <div className='tech-grid2'>
                    <div className='tech-card2'>
                        ...
                        <p className='tech-date2'>11/03/2022</p>
                        <h3 className='tech-title2'>Audi using mixed reality to blaze new trails in communication</h3>
                    ...
                    <div className='tech-card2'>
                        ...
                        <p className='tech-date2'>05/08/2021</p>
                        <h3 className='tech-title2'>AI in production at Audi: “A perfect field of application”</h3>
