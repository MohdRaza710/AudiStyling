    ...
    return (
        <div>
            ...
            <div className='acad-section4'>
                ...
                <h3 className='acad-title4'>Endowed professorship procurement</h3>
            ...
            <div className='acad-section6'>
                <h3 className='acad-title6'>Are you interested in working with Audi?</h3>
                <p className='acad-description6'>Please feel free to contact us via wissenschaftskooperationen@audi.de</p>
                <a className='acad-contact-btn6'>Contact us now</a>
            </div>
